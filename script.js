...
async function bollywoodSong() {
  let data = await fetch(" https://biswajitpanda1234.github.io/4.-music-player/bollywood songs/");
...
async function internationalSong() {
  let data = await fetch(" https://biswajitpanda1234.github.io/4.-music-player/international songs");
